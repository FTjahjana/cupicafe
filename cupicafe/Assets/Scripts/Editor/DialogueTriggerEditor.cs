...
public class DialogueTriggerEditor : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        var dialogues_ListProperty = serializedObject.FindProperty("dialogues");
        ...
        */
        EditorGUILayout.PropertyField(dialogues_ListProperty, true);
        ...
        if (GUILayout.Button("Add Dialogue"))
        {
            ...
            dialogues_ListProperty.arraySize++;
            dialogues_ListProperty.GetArrayElementAtIndex(dialogues_ListProperty.arraySize - 1).managedReferenceValue = newElem;
        }
